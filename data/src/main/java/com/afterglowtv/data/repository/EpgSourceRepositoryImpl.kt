...
import com.afterglowtv.data.epg.EpgNameNormalizer
...
import com.afterglowtv.data.remote.http.safeRequestIdentitySummary
import com.afterglowtv.data.remote.http.withRequestProfile
        ...
        transactionRunner.inTransaction {
            ...
            epgSourceDao.insert(
                EpgSourceEntity(
                    ...
                    url = "afterglowtv://epg-source-staging/${source.id}",
                    enabled = false,
