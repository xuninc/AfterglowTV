...
class RecordingAlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_START_RECORDING = "com.afterglowtv.data.recording.action.START"
        const val ACTION_STOP_RECORDING = "com.afterglowtv.data.recording.action.STOP"
