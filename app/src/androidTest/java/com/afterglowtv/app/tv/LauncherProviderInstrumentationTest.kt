...
class LauncherProviderInstrumentationTest {
    ...
    private fun resourceArtworkUri(): Uri =
        Uri.parse("android.resource://${context.packageName}/${com.afterglowtv.app.R.mipmap.ic_launcher_vault}")

    private fun mainActivityIntentUri(): String =
        Intent(context, com.afterglowtv.app.MainActivity::class.java)
