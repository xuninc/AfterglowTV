...
@AndroidEntryPoint
class AfterglowTVTvInputService : TvInputService() {
    ...
    override fun onCreateSession(inputId: String): Session = AfterglowTVSession(this)

    private inner class AfterglowTVSession(context: Context) : Session(context) {
    ...
    private companion object {
        const val TAG = "AfterglowTVTvInput"
        const val DEFAULT_USER_AGENT = "AfterglowTVTvInput"
